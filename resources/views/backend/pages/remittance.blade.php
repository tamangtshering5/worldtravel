...
@section('body')
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="x_panel">
                    ...
                    @endif
                    <div class="x_title">
                        <button type="button" class="btn btn-info btn-lg" style="background: #2a3f54;" data-toggle="modal" data-target="#myModal">Remittance</button>
                                ...
                                @foreach($remittance as $data)
                                    <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: 110px">
                                        ...
                                        <div class="card hovercard">
                                            ...
                                            <div class="avatar">
                                                <img src="{{URL::to('backend/images/remittance/'.$data->image)}}" alt="" />
                                            </div>
                                            <ul class="list-unstyled user_data">
    ...
    <a class="btn btn-primary" title="edit" href="{{route('remittance_edit',['id'=>$data->id])}}">
