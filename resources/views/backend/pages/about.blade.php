        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="x_panel">
                    ...
                    @endif
                    <div class="x_title">
                        <button type="button" class="btn btn-info btn-lg" style="background: #2a3f54;" data-toggle="modal" data-target="#myModal">About</button>
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: 110px">
                                ...
                                <div class="card hovercard" >
                                    ...
                                    <ul class="list-unstyled user_data">
                                        ...
                                        <li ><b style="float: left;">Objectives:</b>{!! str_limit($data->objectives,50 )!!}
                                        </li><br>

                                        <li ><b style="float: left;">Vision:</b>{!! str_limit($data->vision,50 )!!}
                                        </li><br>

                                        <li ><b style="float: left;">Goals:</b>{!! str_limit($data->goals,50 )!!}
                                        </li><br>
