            ...
            <div class="col-md-5 col-sm-5 col-xs-5">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <a  href="{{route('trekking_tabs')}}" class="btn btn-info btn-lg" style="background: #2a3f54;">Back</a>
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="post"
                              action="{{route('trekkingtabedit_action',['id'=>$datas->id])}}" enctype="multipart/form-data">
                            @if(count($errors)>0)
