                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                            ...
                            <a class="btn btn-success" href="{{route('edit_adminprofile')}}"><i class="fa fa-edit m-right-xs" style="background: #F1931B;"></i>Edit Profile</a>
                            <a class="btn btn-success" href="{{route('register')}}"><i class="fa fa-edit m-right-xs"></i>Add Users</a>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <table class="table table-striped">
                            <thead>
                            <tr>
                                <th style="color:#e62b4c;">Image</th>
                                <th style="color:#e62b4c;">Action</th>
                            </thead>
                            <tbody>
                            ...
                            @foreach($pem as $data)
                                <tr>
                                    <td><img src="{{URL::to('backend/images/profile_image/'.$data->image)}}" style="height:120px;width:120px;"></td>
                                    <td>
