            ...
            <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <a  href="{{route('backend_trekking')}}" class="btn btn-info btn-lg" style="background: #2a3f54;">Back</a>
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="post"
                              action="{{route('trekkingedit_action',['id'=>$datas->id])}}" enctype="multipart/form-data">
                            @if(count($errors)>0)
                            ...
                            <div class="form-group" style="color:#e62b4c;">
                                ...
                                @foreach($datas->TrekkingTab as $data)
                                <div>
