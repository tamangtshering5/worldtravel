...
@section('body')
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="x_panel">
                    ...
                    @endif
                    <div class="x_title">
                        <button type="button" class="btn btn-info btn-lg" style="background: #2a3f54;" data-toggle="modal" data-target="#myModal">Hotel Tabs</button>
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        ...
                                        <div class="card hovercard">
                                            ...
                                            <ul class="list-unstyled user_data">
                                                ...
                                                <li ><b style="float: left;">Special:</b>{!! str_limit($data->special,50 )!!}
                                                </li><br>
    ...
    <a class="btn btn-primary" title="edit" href="{{route('hoteltab_edit',['id'=>$data->id])}}">
