                                ...
                                <li>
                                    ...
                                    <br><div class="block_content">
                                        ...
                                        <h2 class="title">
                                            ...
                                            <b><a style="color:black">Name</a></b> : {{$datas->last_name}}<br><br>
                                            ...
                                            <b><a style="color:black">People </a></b>:&nbsp;&nbsp;{{$datas->people}} <br><br>

                                            <b><a style="color:black">Country </a></b>:&nbsp;&nbsp;{{$datas->country}} <br><br>

                                            <b><a style="color:black">Service </a></b>:&nbsp;&nbsp;{{$datas->service}} <br><br>

                                            <b><a style="color:black">Sub Service </a></b>:&nbsp;&nbsp;{{$datas->sub_service}} <br><br>
