            ...
            <div class="col-md-5 col-sm-5 col-xs-5">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <a  href="{{route('backend_remittance')}}" class="btn btn-info btn-lg" style="background: #2a3f54;">Back</a>
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" method="post"
                              action="{{route('remittanceedit_action',['id'=>$datas->id])}}" enctype="multipart/form-data">
                            @if(count($errors)>0)
                            ...
                            <div class="form-group" style="color:#e62b4c;">
                                ...
                                <div class="jumbotron jumbotron-fluid">
                                    <div class="container">
                                        <img src="{{URL::to('backend/images/remittance/'.$datas->image)}}" style="height:200px">
                                    </div>
                                </div>
