                       ...
                       <div class="" role="tabpanel" data-example-id="togglable-tabs">
                           ...
                           <div id="myTabContent" class="tab-content">
                               <div role="tabpanel" class="tab-pane fade active in" id="profile" aria-labelledby="home-tab">
                                   ...
                                   <form class="form-horizontal form-label-left" method="post" action="{{route('userprofile_action',['id'=>$datas->id])}}" enctype="multipart/form-data">
                                       {{csrf_field()}}
                                       ...
                                       <div class="form-group">
                                           ...
                                           <div>
                                               <input type="text" name="name"  value="{{$datas->name}}" required class="form-control">
                                           </div>
                                       </div>
                                       <div class="form-group">
                                           <label for="category">Email <span class="required"></span> </label>
                                           <div>
                                               <input type="email" name="email"  value="{{$datas->email}}" required class="form-control">
                                           </div>
                                       </div>
                                       <div class="form-group">
                                           <label for="category">Address <span class="required"></span> </label>
                                           <div>
                                               <input type="text" name="address"  value="{{$datas->address}}" required class="form-control">
                                           </div>
                                       </div>
                                       <div class="form-group">
                                           <label for="category">Job <span class="required"></span> </label>
                                           <div>
                                               <input type="text" name="job"  value="{{$datas->job}}" required class="form-control">
                                           </div>
                                       </div>
                                       <div class="form-group">
                               ...
                               <div role="tabpanel" class="tab-pane fade" id="password" aria-labelledby="profile-tab">
                                   ...
                                   <form action="{{route('password_action',['id'=>$datas->id])}}" method="post">
                                       {{csrf_field()}}
