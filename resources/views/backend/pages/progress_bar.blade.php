...
@section('body')
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="x_panel">
                    ...
                    @endif
                    <div class="x_title">
                        <button type="button" class="btn btn-info btn-lg" style="background: #2a3f54;" data-toggle="modal" data-target="#myModal">Progress</button>
                    ...
                    <div class="x_content">
                        <br>
                        @foreach($datas as $data)
                            <div class="col-md-4 col-sm-4 col-xs-4" style="margin-left: 110px">
                                <!-- Modal -->
                                ...
                                <div class="card hovercard" >
                                    ...
                                    <ul class="list-unstyled user_data">
                                        <li ><b style="float: left;">Progress Title:</b>{{$data->title}}
                                        </li><br>

                                        <li ><b style="float: left;">Progress Percentage:</b>{{$data->percentage}}
                                        </li><br>
    ...
    <a class="btn btn-primary" title="edit" href="{{route('progress_edit',['id'=>$data->id])}}">
