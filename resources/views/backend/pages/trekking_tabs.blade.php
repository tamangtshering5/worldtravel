...
@section('body')
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="x_panel">
                    ...
                    @endif
                    <div class="x_title">
                        <button type="button" class="btn btn-info btn-lg" style="background: #2a3f54;" data-toggle="modal" data-target="#myModal">Trekking Tabs</button>
    ...
    <a class="btn btn-primary" title="edit" href="{{route('trekkingtab_edit',['id'=>$data->id])}}">
