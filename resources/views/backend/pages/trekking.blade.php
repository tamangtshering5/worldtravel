...
@section('body')
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal form-label-left" method="post"
                                                  action="{{route('trekking_action')}}" enctype="multipart/form-data">
                                                @if(count($errors)>0)
                                                    @foreach($errors->all() as $error )
                                                ...
                                                <div class="form-group" style="color:#e62b4c;">
                                                    <label for="category">Place_name <span class="required">*</span> </label>
                                                    <div>
                                                        <input type="text" name="place_name" id="place_name" required  class="form-control">
                                                    </div>
                                                </div>
                                ...
                                @foreach($trekking as $data)
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="card hovercard">
                                            ...
                                            <div class="avatar">
                                                <img src="{{URL::to('backend/images/trekking/'.$data->image)}}" alt="image" />
                                            </div>
                                            <ul class="list-unstyled user_data">
                                                ...
                                                <li style="float: left"><b >Place Name:</b>{{$data->place_name}}
                                                </li><br><br>
    ...
    <a class="btn btn-primary" title="edit" href="{{route('trekking_edit',['id'=>$data->id])}}">
        <i class="fa fa-edit"  ></i>
    </a></span>
                                            <span style="float: right; margin-right: 35px;">
                                            <form method="post" action="{{route('trekking_del',['id'=>$data->id])}}">
                                                {{csrf_field()}}
